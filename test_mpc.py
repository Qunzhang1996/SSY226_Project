...
def main():
    ...
    for i in range(2480):
        ...
        # 模拟车辆的一个时间步
        ##############################################################
        # TODO: 在这里可以修改为 carla_state
        carla_state = np.zeros(5)

        # TODO: 修改这里！首先是 x, y, psi, v
        ...
        # 使用轴对象进行绘图
        ax.plot(x_ref, y_ref)
        ax.plot(predicted_trajectories[C_k.X_km, :], predicted_trajectories[C_k.Y_km, :], '-', color='red', label='Predicted Trajectory')
